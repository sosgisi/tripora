...
import { Review, Trip, TripImage } from "@prisma/client";
      ...
      {trips.map((trip, index) => (
        ...
        >
          <div className="relative">
            ...
            />
            <p className="absolute py-0.5 px-2 rounded-full text-xs font-medium top-4 right-4 bg-[#C9A15C] text-white">
          ...
          <div className="p-6">
            ...
            <div className="space-y-2 mb-4">
              ...
              <div className="flex items-center text-sm">
                <Star className="w-4 h-4 ml-2 fill-[#C9A15C] text-[#C9A15C]" />
