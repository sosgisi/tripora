...
import { Edit, MapPin, Calendar, Star, Camera, Bell, Shield, CreditCard, Heart, User } from "lucide-react"
...
export default function ProfilePage() {
  ...
  const recentTrips = [
    ...
    },
    {
      ...
      date: "5-9 نوفمبر 2024",
      status: "completed",
      rating: 5,
    },
    {
      id: 3,
      title: "جولة ثقافية في يوجياكارتا",
      image: "/images/yogyakarta-culture.png",
      date: "20-22 أكتوبر 2024",
      status: "completed",
      rating: 4,
    },
  ]
  ...
  const wishlistTrips = [
    {
      id: 1,
      title: "غوص راجا أمبات",
      image: "/images/raja-ampat-diving.png",
      price: "Rp 8.500.000",
      location: "بابوا الغربية",
    },
    {
      id: 2,
      title: "رحلة عمل رقمية بالي",
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "upcoming":
        return <h1 className="bg-blue-100 text-blue-700 px-2 py-1 rounded">قادمة</h1>
      case "completed":
        return <h1 className="bg-green-100 text-green-700 px-2 py-1 rounded">مكتملة</h1>
      case "cancelled":
        return <h1 className="bg-red-100 text-red-700 px-2 py-1 rounded">أُلغيت</h1>
      default:
        return <h1>غير معروف</h1>
    }
  }
              ...
              <div className="flex flex-col md:flex-row items-start gap-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-4" dir="rtl">
                    <div>
                      <h1 className="text-3xl font-bold text-[#2F4F4F] dark:text-white mb-2">
                  ...
                  { profileData?.role === 'admin' || profileData?.role === 'provider' &&
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4" dir="rtl">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-[#2F4F4F]/60 dark:text-white">الرحلات المنضمة</p>
                      </div>
                      <div className="text-center">
                        <p className="text-2xl font-bold text-[#C9A15C]">{userStats.reviewsGiven}</p>
                        <p className="text-sm text-[#2F4F4F]/60 dark:text-white">المراجعات المقدمة</p>
                      </div>
                      <div className="text-center">
                        <p className="text-2xl font-bold text-[#C9A15C]">{userStats.wishlistCount}</p>
                        <p className="text-sm text-[#2F4F4F]/60 dark:text-white">قائمة الرغبات</p>
                      </div>
                      <div className="text-center">
                        <p className="text-2xl font-bold text-[#C9A15C]">{userStats.memberSince}</p>
                        <p className="text-sm text-[#2F4F4F]/60 dark:text-white">عضو منذ</p>
                      </div>
                    </div>
                  }
                </div>
            ...
            <div className="w-full">
                ...
                <div className="mt-6" dir="rtl">
                  <div className="border-[#2F4F4F]/10 border rounded-lg mb-6">
                    <div className="px-6 py-4 border-b border-[#2F4F4F]/10">
                      <div className="text-[#2F4F4F] text-lg font-bold">سجل الرحلات</div>
                    </div>
                    <div className="px-6 py-4">
                      <div className="space-y-4">
                        {recentTrips.map((trip) => (
                          <div
                            key={trip.id}
                            className="flex items-center gap-4 p-4 border border-[#2F4F4F]/10 rounded-lg"
                          >
                            <Image
              ...
              {activeTab === 'wishlist' && !isEditing && (
                <div className="mt-6" dir="rtl">
                  <div className="border-[#2F4F4F]/10 border rounded-lg mb-6">
                    <div className="px-6 py-4 border-b border-[#2F4F4F]/10">
                      <div className="text-[#2F4F4F] text-lg font-bold">الرحلات المفضلة</div>
                    </div>
                    <div className="px-6 py-4">
                      <div className="grid md:grid-cols-2 gap-6">
                        {wishlistTrips.map((trip) => (
                          <div
                            key={trip.id}
                            className="border border-[#2F4F4F]/10 rounded-lg overflow-hidden"
                          >
                            <Image
                              src={trip.image || "/placeholder.svg"}
                              alt={trip.title}
              ...
              {activeTab === 'reviews' && !isEditing && (
                <div className="mt-6" dir="rtl">
                  <div className="border-[#2F4F4F]/10 border rounded-lg mb-6">
                    <div className="px-6 py-4 border-b border-[#2F4F4F]/10">
                      <div className="text-[#2F4F4F] text-lg font-bold">المراجعات المقدمة</div>
                    </div>
                    <div className="px-6 py-4">
                      <div className="space-y-4">
                        <div className="p-4 border border-[#2F4F4F]/10 rounded-lg">
                          <div className="flex items-start gap-4">
                            <Image
                              ...
                              alt="الإبحار في كومودو"
                              width={60}
                              height={60}
                              className="w-15 h-15 object-cover rounded-lg"
                            />
                            <div className="flex-1">
                              <h4 className="font-semibold text-[#2F4F4F] mb-1">مغامرة الإبحار في كومودو</h4>
                              <div className="flex items-center mb-2">
                                {[...Array(5)].map((_, i) => (
                                  <Star key={i} className="w-4 h-4 fill-[#C9A15C] text-[#C9A15C]" />
                                ))}
                                <span className="mr-2 text-sm text-[#2F4F4F]/60">٥ نوفمبر ٢٠٢٤</span>
                              </div>
                              <p className="text-[#2F4F4F]/80">
                                رحلة رائعة للغاية! مناظر كومودو كانت مذهلة والفريق كان محترفًا جدًا.
                                أنصح بها بشدة!
                              </p>
                            </div>
                          </div>
              ...
              {activeTab === 'settings' && !isEditing && (
                <div className="mt-6 space-y-6" dir="rtl">
                  <div className="border-[#2F4F4F]/10 border rounded-lg mb-6">
                    ...
                    <div className="px-6 py-4 space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="font-medium text-[#2F4F4F]">إشعارات البريد الإلكتروني</p>
                          <p className="text-sm text-[#2F4F4F]/60">استقبال تحديثات الرحلات والعروض عبر البريد الإلكتروني</p>
                        </div>
                        <input type="checkbox" defaultChecked className="rounded" />
                      </div>
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="font-medium text-[#2F4F4F]">إشعارات فورية</p>
                          <p className="text-sm text-[#2F4F4F]/60">إشعارات مباشرة في المتصفح</p>
                        </div>
                        <input type="checkbox" defaultChecked className="rounded" />
                      </div>
                    </div>
                  ...
                  <div className="border-[#2F4F4F]/10 border rounded-lg mb-6">
                    ...
                    <div className="px-6 py-4 space-y-4">
                      <button className="w-full justify-start border border-[#2F4F4F]/10 rounded px-4 py-2 bg-white hover:bg-gray-100">
                        تغيير كلمة المرور
                      </button>
                      <button className="w-full justify-start border border-[#2F4F4F]/10 rounded px-4 py-2 bg-white hover:bg-gray-100">
                        التحقق بخطوتين
          ...
          { isEditing &&
            <div className="border-[#2F4F4F]/10 border-2 rounded-md p-5">
              {isLoading ? (
                ...
                <>
                  <div>
                    <h1 className="text-[#2F4F4F] cursor-pointer mb-5">تعديل الملف الشخصي</h1>
                  </div>
                  <div className="space-y-4">
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        <label className="text-sm font-medium text-[#2F4F4F] mb-1 block">الاسم الكامل</label>
                        <input
                          value={profileDataEdited?.name}
                          disabled={session?.user?.name ? true : false}
                          onChange={(e) =>
                            setProfileDataEdited({ ...profileDataEdited, name: e.target.value })
                          }
                          className="w-full border rounded py-1 px-3 border-[#2F4F4F]/20 focus:border-[#C9A15C]"
                        />
                      </div>
                      <div>
                        <label className="text-sm font-medium text-[#2F4F4F] mb-1 block">البريد الإلكتروني</label>
                        <input
                          type="email"
                          value={profileDataEdited?.email}
                          disabled={session?.user?.email ? true : false}
                          onChange={(e) =>
                            setProfileDataEdited({ ...profileDataEdited, email: e.target.value })
                          }
                          className="w-full border rounded py-1 px-3 border-[#2F4F4F]/20 focus:border-[#C9A15C]"
                        />
                      </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        <label className="text-sm font-medium text-[#2F4F4F] mb-1 block">رقم الهاتف</label>
                        <input
                          value={profileDataEdited?.phonenumber}
                          onChange={(e) =>
                            setProfileDataEdited({ ...profileDataEdited, phonenumber: e.target.value })
                          }
                          className="w-full border rounded py-1 px-3 border-[#2F4F4F]/20 focus:border-[#C9A15C]"
                        />
                      </div>
                      <div>
                        <label className="text-sm font-medium text-[#2F4F4F] mb-1 block">الموقع</label>
                        <input
                          value={profileDataEdited?.location || ""}
                          onChange={(e) =>
                            setProfileDataEdited({ ...profileDataEdited, location: e.target.value })
                          }
                          className="w-full border rounded py-1 px-3 border-[#2F4F4F]/20 focus:border-[#C9A15C]"
                        />
                      </div>
                    ...
                    <div>
                      <label className="text-sm font-medium text-[#2F4F4F] mb-1 block">نبذة عنك</label>
                      <textarea
                        value={profileDataEdited?.bio || ""}
                        onChange={(e) =>
                          setProfileDataEdited({ ...profileDataEdited, bio: e.target.value })
                        }
                    ...
                    <div className="flex gap-4">
                      <button
                        ...
                        className="py-1 px-3 rounded bg-[#C9A15C] hover:bg-[#C9A15C]/90 text-white cursor-pointer transform duration-200"
                      >
                        حفظ التغييرات
                      </button>
                      <button
                        onClick={() => setIsEditing(false)}
                        className="flex items-center py-1 px-3 rounded border border-[#2F4F4F] text-[#2F4F4F] hover:bg-[#2F4F4F] hover:text-white cursor-pointer transform duration-200"
                      >
                        إلغاء
                      </button>
                    </div>
